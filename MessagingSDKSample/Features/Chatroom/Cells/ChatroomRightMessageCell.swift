//
//  ChatroomRightMessageCell.swift
//  MessagingSDKSample
//
...
class ChatroomRightMessageCell: UITableViewCell {
...
extension ChatroomRightMessageCell: CustomCell {
...
private extension ChatroomRightMessageCell {
    ...
    func setupUI() {
        ...
        messageView.backgroundColor = .rightMessageColor
        ...
        NSLayoutConstraint.activate([
            ...
            messageView.leadingAnchor.constraint(equalTo: timeLabel.trailingAnchor, constant: padding),
            ...
            timeLabel.leadingAnchor.constraint(greaterThanOrEqualTo: containerView.leadingAnchor, constant: messageEdgePadding),
            
            statusImageView.topAnchor.constraint(equalTo: messageView.topAnchor),
            statusImageView.trailingAnchor.constraint(equalTo: timeLabel.trailingAnchor),
